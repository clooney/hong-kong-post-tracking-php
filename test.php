...
$extraInfo['lang']                 = 'en';
$track = $track->createTracking('hong-kong-post','EV835231465CN',$extraInfo);

//4 List all trackings (列出多个物流信息)
//$track = $track->getTrackingsList($numbers = "EV835231465CN",$orders = "",$page = 1,$limit = 100,$createdAtMin = 0,$createdAtMax = 0,$update_time_min = 0,$update_time_max = 0,$order_created_time_min = 0,$order_created_time_max = 0,$lang = "en");

//5 Get tracking results of a single tracking (列出单个运单号物流信息)
//$track = $track->getSingleTrackingResult("hong-kong-post","EV835231465CN",'en');

//6 create muti tracking number (创建多个运单号)
//$items = array(
//    array(
//        'tracking_number' => 'EV835231465CN',
...
//$extraInfo['destination_code'] = 'US';
//$extraInfo['status']       = '7';
//$track = $track->updateTrackingItem('hong-kong-post','EV835231465CN',$extraInfo);

//8 Delete a tracking item (删除单个运单号)
//$track = $track->deleteTrackingItem('hong-kong-post','EV835231465CN');

//9 Get realtime tracking results of a single tracking (获取单个运单号实时物流信息)
// $track = $track->getRealtimeTrackingResults("hong-kong-post","EV835231465CN",array("lang"=>'en'));

//10 Modify courier code (修改运输商简码)
//$r = $track->updateCarrierCode("EV835231465CN","hong-kong-post","china-ems");
...
//$date = array();
//$data[] = array("tracking_number"=>"EV835231465CN","carrier_code"=>"hong-kong-post");
...
//$data = array();
//$data[] = array("original"=>"CN","destination"=>"US","carrier_code"=>"hong-kong-post");
